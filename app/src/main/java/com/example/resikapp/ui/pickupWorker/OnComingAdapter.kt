...
class OnComingAdapter(private val listener: OnItemClickListener) : RecyclerView.Adapter<OnComingAdapter.ViewHolder>() {
    ...
    interface OnItemClickListener {
        fun onItemClick(pesanan: HistoryPesananItem)
    }
}
